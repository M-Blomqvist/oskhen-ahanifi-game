...
class Bullet(arcade.Sprite):
    def __init__(self, player_name, filename, scaling, max_bounces, speed=7):
        super().__init__(filename, scaling)
        self.shot_by = player_name
        self.name = "Bill"
        self.bounces = 0
...
class Player(arcade.Sprite):
    ...
    def shoot(self):
        ...
        if self.cooldowns["shoot"].ready():
            ...
            bullet = Bullet(self.name, "./sprites/weapon_gun_purple.png", 1, 4)
            ...
            angle = math.atan2(self.facing_direction.y,
    ...
    def take_damage(self, shot_by, damage):
