...
class GameView(arcade.View):
    ...
    def __init__(self):
        ...
        self.boardstate = [[["" for _ in range(2)] for _ in range(
            32)] for _ in range(56)]  # mapsize 32x56 tiles
    ...
    def setup(self):
        ...
        self.bg_sprites = [["walls", self.wall_list], [
            "floor", self.floor_list], ["deadly", self.deadly_list]]
        ...
        self.player1 = logic.Player(self, "sprites/duck_pixel.png", TILE_SCALING - 0.2,
                                    settings["p1_movement"], settings["p1_action"], 100, self.window.height / 2, settings["p1_name"], Vec2d(1, 0))

        self.player2 = logic.Player(self, "sprites/duck_pixel_red.png", TILE_SCALING - 0.2,
                                    settings["p2_movement"], settings["p2_action"], self.window.width - 200, self.window.height / 2, settings["p2_name"], Vec2d(-1, 0))
    ...
    def setup_map(self, map_path):
        ...
        # extend appends spriteList #No it doesn't, it *extends* spriteList..
        self.all_sprites.extend(self.floor_list)
    ...
    def on_update(self, delta_time):
        ...
        for agent in self.agents:
            ...
            inputs.move_keys_pressed = inputs.move_keys_pressed.fromkeys(
                inputs.move_keys_pressed, False)
            inputs.abilities_pressed = inputs.abilities_pressed.fromkeys(
                inputs.abilities_pressed, False)
            keys = agent.predict()
            for key in keys:
...
class MenuView(arcade.View):
    ...
    def on_draw(self):
        ...
        arcade.start_render()
        self.screenlist[self.currentselection].draw_sized(
...
class GameOverView(arcade.View):
    ...
    def on_draw(self):
        ...
        arcade.draw_text("Press R to play again", SCREEN_WIDTH / 2, SCREEN_HEIGHT /
                         2 - 100, arcade.color.WHITE, font_size=20, anchor_x="center")
        arcade.draw_text("Press M to go to main menu", SCREEN_WIDTH / 2, SCREEN_HEIGHT /
                         2 - 150, arcade.color.WHITE, font_size=20, anchor_x="center")
        arcade.draw_text("Press Q to quit", SCREEN_WIDTH / 2, SCREEN_HEIGHT /
                         2 - 200, arcade.color.WHITE, font_size=20, anchor_x="center")
